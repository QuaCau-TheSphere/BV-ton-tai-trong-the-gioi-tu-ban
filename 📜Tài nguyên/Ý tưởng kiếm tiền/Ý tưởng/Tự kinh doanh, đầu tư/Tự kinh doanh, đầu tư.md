...
```dataview
LIST rows.file.link
FROM "📜Tài nguyên/Ý tưởng kiếm tiền/Ý tưởng/Tự kinh doanh, đầu tư/Kết nối nhu cầu" 
...
```dataview
LIST 
FROM "📜Tài nguyên/Ý tưởng kiếm tiền/Ý tưởng/Tự kinh doanh, đầu tư/Học tập, phát triển bản thân" 
```

## Gia công giải pháp
```dataview
LIST 
FROM "📜Tài nguyên/Ý tưởng kiếm tiền/Ý tưởng/Tự kinh doanh, đầu tư/Gia công giải pháp" 
```
