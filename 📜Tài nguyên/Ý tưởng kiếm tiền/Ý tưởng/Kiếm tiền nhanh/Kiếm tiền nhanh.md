...
FROM "📜Tài nguyên/Ý tưởng kiếm tiền/Ý tưởng/Kiếm tiền nhanh"
WHERE file.name != this.file.name
WHERE !contains(file.folder, "Gian lận công ty")
```
...
![Tất cả các việc làm thêm thời sinh viên trong 14 phút - YouTube](https://youtu.be/n-L0TQr-obI?si=E97KyPTzNL2ZbEWb)
